...
```text
/xxd-panel-095 <source-or-directory> --mode top-bottom,design-only \
...
1. 上下对照（原图在上，095 设计在下）
2. 左右对照（原图在左，095 设计在右）
...
```text
~/Desktop/xxd/xxd-panel-095/<fresh-task>/
...
- `references/xxd-panel-095-prompt.zh-CN.md`
- `references/xxd-panel-095-prompt.en.md`
