<p align="center"><img src="./assets/banner.svg" alt="XXD Panel 095 project banner" width="1200"></p>
...
Sample positions are reserved. Verifiable original works or extensions reviewed directly against the Panel 095 source brief will be shown here first; images from another numbered Panel and broken placeholders are never substituted.
...
| **[xxd-panel-092](https://github.com/nevertoday/xxd-panel-092)** | EXPRESSIVE BLACK INK · FREE CONTOUR · GEOMETRIC／SCRIBBLE HATCHING · NEGATIVE SPACE · PAPER WHITE · PHILOSOPHICAL RESTRAINT |
| **[xxd-panel-093](https://github.com/nevertoday/xxd-panel-093)** | GEOMETRIC FLAT COLOUR · FLATTENED SPACE · VIVID SOURCE COLOUR · HANDMADE EDGES · MATTE GOUACHE · MID-CENTURY EDITORIAL |
| **[xxd-panel-095](https://github.com/nevertoday/xxd-panel-095)** | BLACK TECHNICAL LINE · PICTOGRAPHIC SIMPLIFICATION · RED SPOT COLOUR · MODULAR DIAGRAM · WARM PAPER · VINTAGE PRINT |
...
| **Soldiers** | `xxd-panel-NNN` (currently 001–095) | Each numbered Skill executes only its own original brief and aesthetic, completing the individual job assigned by the General. |
