<p align="center"><img src="./assets/banner.svg" alt="لافتة مشروع XXD Panel 095" width="1200"></p>

<div align="center">

# 🦁 XXD Panel 095｜دفتر الرسوم التوضيحية بالأحمر والأسود

### يشرح الصورة بخطوط تقنية سوداء ولون أحمر موضعي ووحدات تخطيطية
...
تبقى `sample-01`–`sample-04` محجوزة لنماذج الإصدار الأصلية القابلة للتحقق. تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 095 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.

<!-- xxd-human-intro:start -->
## ما الذي يحله هذا الأسلوب؟

قد يشبه الرسم الزخرفي الصورة، لكنه لا يوضح ما الذي يجعل الموضوع قابلاً للتعرّف ولا كيف ترتبط أجزاؤه.

يضغط **Panel 095** الصورة في لوحة تحريرية تخطيطية بروح منتصف القرن. يشرح الخط التقني الأسود الهوية والبنية، ويشير اللون الأحمر الموضعي بدقة إلى العقدة أو المسار أو الإشارة أو الكلمة الحاسمة، بينما تحوّل الرموز المصورة المعيارية والفراغ الواسع على ورق دافئ التعقيد إلى مسار قراءة ذكي وواضح.

### مناسب لـ

- اختزال موضوع معقد إلى محيطه الجوهري وعقده البنيوية واتجاهه وحركته وعلاقته الرمزية؛
- استحضار ألواح الأدلة التقنية وخرائط النقل وتصميم المعلومات المبكر من دون شبكة جامدة؛
- طباعة ثنائية بالأسود والأحمر، وتعليقات حداثية ضيقة، وحبيبات حبر وألياف ورق وانزياح تسجيل وطباعة متراكبة؛
- مخرجات أعلى–أسفل ويسار–يمين وتصميم فقط ونسب متعددة وحزم خلفيات ومعالجة المجلدات.

### بداية سريعة

> استخدم XXD Panel 095 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
**البصمة:** خط تقني أسود · تبسيط تصويري · أحمر موضعي · مخطط معياري · ورق دافئ · طباعة قديمة
...
|---|---|
| **الناتج** | مخطط تحريري إنساني واضح بروح منتصف القرن يشرح الصورة بدلاً من مجرد تزيينها |
| **البصمة الواضحة** | خط تقني أسود رفيع، وأحمر موضعي منضبط، ورموز معيارية، وفراغ ورقي دافئ واسع، وعيوب طباعة قديمة طفيفة |
| **احترام المصدر** | يضغط الهوية والمحيط والبنية والوضع والاتجاه والعلاقة السردية في أقل قدر من المعلومات البصرية الدقيقة |
...
```text
تحليل الموضوع والمحيط والبنية والوضع والعلاقة السردية → اختزالها إلى الخطوط والعقد والاتجاهات والحركات والرموز الحاسمة → إنشاء مخطط رئيسي واحد واضح → إضافة أقل عدد لازم من المخططات المساندة → بناء مسار القراءة باختلاف المقياس والإزاحة والمحاذاة وخطوط الإرشاد → الرسم بخط تقني أسود على ورق دافئ → وضع الأحمر الموضعي في نقاط التأكيد الضرورية فقط → دمج تعليقات حداثية صغيرة وضيقة → الاحتفاظ بحبيبات الحبر وألياف الورق وانزياح التسجيل والطباعة المتراكبة برفق
```

## سمات النتيجة النهائية

- يحمل الخط الأسود أو الحبري الرفيع والمتجانس معظم المحيط والبنية والمعلومات.
- يقتصر القرمزي أو الأحمر المرجاني أو أحمر الطباعة على البنية أو عقدة الحركة أو المسار أو الإشارة أو المنطقة أو الكلمة أو الرمز الحاسم.
- يبقى مركز بصري واحد واضح؛ وتشرح المخططات المساندة من دون إنشاء مركز سردي ثانٍ.
- تُعامل الكتابة الصغيرة الضيقة بلا زوائد كتعليق تحريري يصطف مع الرموز وخطوط الإرشاد والعلامات الحمراء والفراغ.
- يُحفظ الفضاء المسطح مع ألياف الورق وحبيبات الحبر وانزياح التسجيل والطباعة المتراكبة بخفة، وتُتجنب التدرجات والإنفوغرافيك متعدد الألوان وواجهات التقنية والشبكات الجامدة والزخرفة الزائدة ومرشحات التعتيق الزائفة والقوالب الرجعية.

توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-095-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 095. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-095 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-095 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-095 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-095 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-095 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 095 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-095 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-095`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-095-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-095-prompt.zh-CN.md)
...
| **[xxd-panel-092](https://github.com/nevertoday/xxd-panel-092)** | حبر أسود تعبيري · محيط حر · تهشير هندسي／خربشي · فراغ سلبي · بياض الورق · ضبط فلسفي |
| **[xxd-panel-093](https://github.com/nevertoday/xxd-panel-093)** | لون هندسي مسطح · فضاء مسطح · لون زاهٍ من المصدر · حواف يدوية · غواش مطفأ · تحرير منتصف القرن |
| **[xxd-panel-095](https://github.com/nevertoday/xxd-panel-095)** | خط تقني أسود · تبسيط تصويري · أحمر موضعي · مخطط معياري · ورق دافئ · طباعة قديمة |
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–095) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
